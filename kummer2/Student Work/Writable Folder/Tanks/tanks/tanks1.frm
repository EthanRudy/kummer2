...
h = 1
imgpb2.Visible = True
Kill ("\\Gk08\student work\Writable Folder\Tanks\player1.txt")
Path = "\\Gk08\student work\Writable Folder\Tanks\player1.txt"
...
Print #1, arrp1(1)
Close #1
path2 = "\\Gk08\student work\Writable Folder\Tanks\player2.txt"
...
Next r
Close #1
imgpb2.Top = Val(arrnet(1))
imgpb2.Left = Val(arrnet(2))
Image2.Left = Val(arrnet(3))
Image2.Top = Val(arrnet(4))
p2score = Val(arrnet(5))
lblp2score = p2score
arrp2(1) = Val(arrnet(6))
If arrp2(1) = "1" Then
