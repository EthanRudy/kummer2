...
If Person.Gender = "M" Then
    frmLife.imgplayer.Picture = LoadPicture("E:\male.jpg")
Else
    frmLife.imgplayer.Picture = LoadPicture("E:\female.jpg")
End If

If Person2.Gender = "M" Then
    frmLife.imgPlayer2.Picture = LoadPicture("E:\male.jpg")
Else
    frmLife.imgPlayer2.Picture = LoadPicture("E:\female.jpg")
End If
