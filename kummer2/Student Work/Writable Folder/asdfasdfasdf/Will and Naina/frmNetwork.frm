...
'frmLife.Hide
'frmIntroLife.Show
'PersonNumber = InputBox("Player # pl0xzors")


imgPlayer2.Picture = LoadPicture("H:\male.jpg")
imgplayer.Picture = LoadPicture("H:\male.jpg")
Money1 = 100000
lblMoney = Money1
Money2 = 100000
SPace = 0
...
'If Flags = 1 Then
Path = "\\Gk08\student work\Writable Folder\Will and Naina\Will and Naina\data.txt" '
...
Path = "\\Gk08\student work\Writable Folder\Will and Naina\Will and Naina\data2.txt" '
...
imgPlayer2.Top = lblFemale(Space2).Top
imgPlayer2.Left = lblFemale(Space2).Left
...
'If Flag = 1 Then
Path = "\\Gk08\student work\Writable Folder\Will and Naina\Will and Naina\turn.txt"
