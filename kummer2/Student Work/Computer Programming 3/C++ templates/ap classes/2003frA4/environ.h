...
class Environment
{
  public:
    ...
    Environment(istream & input);
      ...
      // added constructor for algae
    Environment(istream & input, istream & algaeIn);
    // precondition:  input and algaeIn are open for reading in correct format
    // postcondition: environment initialized and populated from input,
    //                algae populated from algaeIn
